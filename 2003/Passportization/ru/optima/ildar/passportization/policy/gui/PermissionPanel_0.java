...
public class PermissionPanel_0 extends JPanel {
	...
	public PermissionPanel_0(BrowserFrame_0 frame) throws PersistenceException {
		this.frame = frame;
	...
	class PermTableModel extends AbstractTableModel {
		...
		public void correctPerm() throws PersistenceException {
			...
			if (ug instanceof UserGroup) {
				...
				perm.addAll(Permission.getListGroupPermForSubTopic(groupID, subTopicID));
			}
			fireTableDataChanged();
		}
	}
